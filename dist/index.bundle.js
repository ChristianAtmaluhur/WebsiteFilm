...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js!./node_modules/bootstrap/dist/css/bootstrap.min.css
var bootstrap_min = __webpack_require__(105);
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js!./src/style/main.css
...
var main_main = function main() {
  ...
  var APIKey = '374e68a61ddf3586ea4ffed09f873d81';
  ...
  var ratingColor = function ratingColor(rating) {
    if (rating < 6) {
  ...
  var renderCard = function renderCard(arr) {
    ...
    arr.forEach(function (element) {
      listsDOM += "<div class=\"card\" aria-details=\"".concat(element.id, "\">\n                    <img src=\"https://image.tmdb.org/t/p/original").concat(element.poster_path, "\" class=\"card-img-top\">\n                    <span class=\"position-absolute badge ").concat(ratingColor(element.vote_average), "\">").concat(element.vote_average, "</span>\n                  </div>");
    });
    container.innerHTML = listsDOM;
  };
  var fetchMovie = function fetchMovie() {
    var lists = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'now_playing';
    fetch("".concat(baseURL).concat(lists, "?api_key=").concat(APIKey, "&language=en-US&page=1")).then(function (response) {
  ...
  fetchMovie();
  var navbarLists = document.querySelectorAll('.genre-list');
  var _iterator = _createForOfIteratorHelper(navbarLists),
    _step;
  try {
    var _loop = function _loop() {
      ...
      list.addEventListener('click', function (e) {
        e.preventDefault();
        var _iterator2 = _createForOfIteratorHelper(navbarLists),
          _step2;
        try {
...
/* harmony default export */ const scripts_main = (main_main);
;// CONCATENATED MODULE: ./src/scripts/custom.js
...
/* eslint-disable no-restricted-syntax */var KatfilmNavbar = /*#__PURE__*/function (_HTMLElement) {
  _inherits(KatfilmNavbar, _HTMLElement);
  var _super = _createSuper(KatfilmNavbar);
  function KatfilmNavbar() {
    _classCallCheck(this, KatfilmNavbar);
    return _super.apply(this, arguments);
  }
  _createClass(KatfilmNavbar, [{
  ...
  return KatfilmNavbar;
}( /*#__PURE__*/_wrapNativeSuper(HTMLElement));
/* harmony default export */ const custom = (KatfilmNavbar);
...
customElements.define('katfilm-navbar', custom);
...
/******/ __webpack_require__.O(0, [712], () => (__webpack_exec__(199)));
